...
- (void) setup {
     ...
     */
    CGRect screen = CGRectMake(10, 10, 300, 450);;
    ...
    _imageStreamV.frame = CGRectMake(10, 10, 300, 450);
    _imageStreamV.layer.borderWidth = 1.0f;
    _imageStreamV.layer.borderColor = [UIColor redColor].CGColor;
