...
//can be same key
#define GOOGLEMAP_IOS_KEY @"AIzaSyDtRdNIuvkvb3VOPRgiuaCaMYFFBPivXnY" //Key for iOS apps
#define GOOGLEMAP_API_KEY @"AIzaSyDtRdNIuvkvb3VOPRgiuaCaMYFFBPivXnY" //Key for API Access authenticaition
